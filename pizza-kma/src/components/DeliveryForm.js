...
function DeliveryForm({ dialogOpen, handleDialogClose }) {
	const { bucketList, totalPrice } = usePizzaContext();
  ...
  <input className="form-check-input" type="checkbox" value="" id="dontCall" checked={userData.dontCall} onChange={()=>setUserData({...userData, dontCall: !userData.dontCall})}/>
